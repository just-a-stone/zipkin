...
public class JsonAdaptersTest {
  ...
  public void binaryAnnotation_long_read() throws IOException {
    ...
    List<SimpleSpan> spans = SimpleSpanConverter.fromSpan(JsonAdapters.SPAN_ADAPTER.fromJson(json));
  ...
  public void readSpan() throws IOException {
    ...
    SimpleSpan simple = SimpleSpanConverter.fromSpan(span).get(0);
    Buffer bytes = new Buffer();
    bytes.write(SimpleSpanCodec.JSON.writeSpan(simple));
  ...
  public void specialCharsInJson() throws IOException {
    ...
    assertThat(SPAN_ADAPTER.fromJson(bytes))
        .isEqualTo(SimpleSpanConverter.toSpan(worstSpanInTheWorld));
  }
